  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      >
        ...
        <div
          className="w-14 h-14 rounded-full flex items-center justify-center shadow-lg group-hover:scale-[1.08] transition-transform duration-200"
      ...
      >
        ...
        <div className="w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg group-hover:scale-[1.08] transition-transform duration-200">
          <svg className="w-7 h-7 fill-white" viewBox="0 0 24 24">
