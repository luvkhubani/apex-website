            ...
            {activeVariant?.inStock ? (
              <div className="flex flex-col gap-2">
                <a
                  ...
                  className="flex items-center justify-center gap-2 text-[13px] font-bold text-white bg-[#25D366] py-2 rounded-pill hover:opacity-90 active:scale-[0.98] transition-all"
                >
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 text-[13px] font-bold text-white bg-apple-black py-2 rounded-pill hover:opacity-80 active:scale-[0.98] transition-all"
                >
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
