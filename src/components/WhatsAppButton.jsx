 ...
 * Clicking opens a WhatsApp chat with a pre-filled greeting.
 */
export default function WhatsAppButton() {
  return (
    <a
      ...
      aria-label="Chat with Apex on WhatsApp"
      className="
    ...
    >
      ...
      <span className="
        ...
        bg-black text-white text-xs font-medium px-3 py-1.5 rounded-full
