            ...
            {activeVariant?.inStock ? (
              <div style={{display:'flex', flexDirection:'column', gap:'8px'}}>
                <a
                  ...
                  style={{display:'flex', width:'100%', alignItems:'center', justifyContent:'center', gap:'8px'}}
                  className="text-[15px] font-bold text-white bg-[#25D366] py-2.5 rounded-pill hover:opacity-90 active:scale-[0.98] transition-all"
                >
                ...
                <a
                  ...
                  style={{display:'flex', width:'100%', alignItems:'center', justifyContent:'center', gap:'8px'}}
                  className="text-[15px] font-bold text-white bg-apple-black py-2.5 rounded-pill hover:opacity-80 active:scale-[0.98] transition-all"
                >
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
