          ...
          <div className="flex-1 p-7 sm:p-8 overflow-y-auto flex flex-col">
            ...
            {activeVariant?.inStock ? (
              <a
                ...
                className="flex items-center justify-center gap-2 text-[15px] font-semibold text-white bg-[#25D366] py-3.5 rounded-pill hover:opacity-90 active:scale-[0.98] transition-all"
              >
